...
export default function BetInputTitle({
	...
	return (
		<Box sx={{ mt: 1.5, textAlign: 'center', maxWidth: '20rem' }}>
			...
			>
				...
				<AccordionDetails>
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.homeTeamWin_GoalsTotalLess.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.homeTeamWin_GoalsTotalMore.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.homeTeamNotLose_GoalsTotalLess.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.homeTeamNotLose_GoalsTotalMore.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.awayTeamWin_GoalsTotalLess.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.awayTeamWin_GoalsTotalMore.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.awayTeamNotLose_GoalsTotalLess.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
					...
					>
						...
						<AccordionDetails>
							{allBetsTitles.gameResult_GoalsAmount.awayTeamNotLose_GoalsTotalMore.map((b) => (
								<Button
									key={b}
									sx={{
										px: 0,
			...
			{/* Таймы */}
			<Accordion expanded={expandedAccordion === 'Таймы'} onChange={handleAccordionChange('Таймы')}>
				<AccordionSummary
					expandIcon={<ExpandMoreIcon />}
				...
				<AccordionDetails>
						...
						<AccordionDetails>
							{allBetsTitles.half.firstHalf_gameScore.map((b) => (
								<Button
									...
									onClick={() => handleButtonClick(b)}
								>
									<Typography sx={{ fontWeight: 600, fontSize: '0.88rem' }}>{b}</Typography>
								</Button>
							))}
						</AccordionDetails>
					</Accordion>
					...
					<Accordion
						...
						onChange={handleNestedAccordionChange('Тайм с большим количеством голов')}
					>
						<AccordionSummary
							expandIcon={<ExpandMoreIcon />}
						...
						>
							<Typography sx={{ fontSize: '0.85rem' }}>Тайм с большим количеством голов</Typography>
						</AccordionSummary>
						<AccordionDetails>
			...
			>
				...
				<AccordionDetails>
					...
					<Accordion
						expanded={expandedNestedAccordion === 'Хозяева - Индивидуальный тотал голов'}
						onChange={handleNestedAccordionChange('Хозяева - Индивидуальный тотал голов')}
					>
						<AccordionSummary
							expandIcon={<ExpandMoreIcon />}
						...
						>
							<Typography sx={{ fontSize: '0.95rem' }}>Хозяева - Индивидуальный тотал</Typography>
						</AccordionSummary>
						<AccordionDetails>
					...
					<Accordion
						expanded={expandedNestedAccordion === 'Гости - Индивидуальный тотал голов'}
						onChange={handleNestedAccordionChange('Гости - Индивидуальный тотал голов')}
					>
						<AccordionSummary
							expandIcon={<ExpandMoreIcon />}
						...
						>
							<Typography sx={{ fontSize: '0.95rem' }}>Гости - Индивидуальный тотал</Typography>
						</AccordionSummary>
						<AccordionDetails>
			...
			{/* Форы */}
			<Accordion expanded={expandedAccordion === 'Форы'} onChange={handleAccordionChange('Форы')}>
				<AccordionSummary
					expandIcon={<ExpandMoreIcon />}
						...
						<AccordionDetails>
							{allBetsTitles.gameScore.normalGameScore.map((b) => (
								<Button
									...
									onClick={() => handleButtonClick(b)}
								>
									<Typography sx={{ fontWeight: 600, fontSize: '0.9rem' }}>{b}</Typography>
								</Button>
							))}
						</AccordionDetails>
					</Accordion>
			...
			{/* Голы */}
			<Accordion expanded={expandedAccordion === 'Голы'} onChange={handleAccordionChange('Голы')}>
				<AccordionSummary
					expandIcon={<ExpandMoreIcon />}
						...
						<AccordionDetails>
							{allBetsTitles.goals.anyTeamScoresMoreThan.map((b) => (
								<Button
									...
									onClick={() => handleButtonClick(b)}
								>
									<Typography sx={{ fontWeight: 600, fontSize: '0.8rem' }}>{b}</Typography>
								</Button>
							))}
						</AccordionDetails>
					</Accordion>
