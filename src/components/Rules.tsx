	...
	return (
		<Container>
			<Box sx={{ mx: 0.5, my: 3, textAlign: 'left' }}>
				...
				<Typography sx={{ my: 1 }}>
					<b>1.1 Оплата сайта</b> - около 70 евро за хостинг + 10 евро за домен. Итого на содержание
					и обслуживание нашего замечательного сайта требуется около 80 евро (за сезон). Если я
					смогу найти более дешевый вариант, я сообщу. Но пока что придется смириться с этими
