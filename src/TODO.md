...
# HOTFIX -----------------
- для championat.com и возможно других API в properties зашиты ID сезонов лиг и они не статичны. Возможно стоит в базе хранить (в app_settings) данные по провайдерам об ID сезонов с привязкой к ID моих сезонов
