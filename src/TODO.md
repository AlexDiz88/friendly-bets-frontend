...
- скретч кэфов с сайтов
- формат туров / слотов ставок сделать более стильно

# БАГИ -----------------
- проверить ставки/кэфы, их корректную интерпретацию в правильные ставки, а также маппинг с моими bet codes
- удаление ставки (влияние на календарь по турам)
- чипы появляются по непонятной схеме (удалить колеекции и попробовать снова)
- добавить возможность принудительного запроса на odds-api для синхронизации / получения чипов

# ПОСЛЕ ДЕПЛОЯ -----------------
- выставить подтверждение емейлов на аккаунтах
- выставить даты сезонов вернуть определение сезона для footbal-data как стартовый год. Я менял вынужденно для тестов ЧМ
- проверить форматы / заполнить
- отредактировать / добавить команды + football-data IDs
- добавить сезон , лигу, формат, команды
- добавить все туры в календарь (с настройкой лимитов ставок на каждый тур)
- сделать фетчи результатов и кэфов
