# УСПЕТЬ ДО ЧМ -----------------
- ~~автоматическое подведение итогов ставок после фетча результатов матчей~~ (сервер: FootballDataSyncScheduler + AutoBetSettlementService)
- оптимизация массовой обработки нескольких ставок после фетча
- восстановление пароля по емейл
- проверка подлиности емейла
